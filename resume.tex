...
%%Begin%% Body
{
    ...
    \textbf{Web Application Developer at \textit{Adknown Inc.}}{\color{darkgrey}\hfill{\small{September 2015 to December 2015\\[5pt]}}
        Worked on dozens of WordPress sites doing system administration, and in-house plugin integration. Wrote highly optimized JavaScript user analyzing scripts, built dynamic JavaScript \& CSS3 ads, and wrote many highly efficient cron job scripts. Designed an Amazon Web Services web application.\\
    }
